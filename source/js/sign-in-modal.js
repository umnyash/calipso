class SignInModal {
  ...
  #initPristine = () => {
    this.#codeRequestFormPristine = new Pristine(this.#codeRequestFormElement , { // eslint-disable-line
    ...
    this.#codeSendingFormPristine = new Pristine(this.#codeSendingFormElement , { // eslint-disable-line
      classTo: 'modal-form__item',
      errorClass: 'invalid',
      errorTextParent: 'modal-form__item',
      errorTextTag: 'p',
